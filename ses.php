...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
		...
		<h2 class="text-left" >SES Resource Availability</h2>
		<ul class="pager">
    ...
    <script src="includes/sesAvailability.js"></script>
	<script>
		var m = new Date(); //setup the current month and the inputs for changing months
		...
		$('#olderRef').click(function(){
			...
			var newMonth;
			var newYear;
			if (newTempMonth == 0){ //handle Jan to Dec change
				newMonth = 11;
		...
		$('#newerRef').click(function(){ 
			...
			var newMonth;
			var newYear;		
			if (newTempMonth == 11){ //handle Jan to Dec change
				newMonth = 0;
				newYear = currentYear + 1;
			}else{
				newMonth = newTempMonth + 1;
